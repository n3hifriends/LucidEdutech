 ...
 */
export function CardImage(props: CardProps) {
  const {
    source,
    content,
    contentTx,
    ...
    >
      ...
      <View style={$alignmentWrapperStyle}>
        <HeaderContentWrapper>
          ...
          {ContentComponent ||
            (isContentPresent && (
              <Image source={source} style={{ alignSelf: "center", height: 50, width: 50 }} />
            ))}
        </HeaderContentWrapper>
...
const $containerPresets = {
  ...
  reversed: [
    $containerBase,
    { backgroundColor: colors.palette.neutral100, borderColor: colors.palette.neutral500 },
  ] as StyleProp<ViewStyle>,
}
...
const $footerPresets: Record<Presets, TextStyle> = {
  default: {},
  reversed: { color: colors.palette.neutral100, alignSelf: "center" },
}
